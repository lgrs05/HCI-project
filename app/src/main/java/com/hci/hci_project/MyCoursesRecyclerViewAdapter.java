...
import com.hci.hci_project.CoursesFragment.OnListFragmentInteractionListener;
...
public class MyCoursesRecyclerViewAdapter extends RecyclerView.Adapter<MyCoursesRecyclerViewAdapter.ViewHolder> {
    ...
    public MyCoursesRecyclerViewAdapter(List<String> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
